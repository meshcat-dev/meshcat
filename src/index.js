...
class Viewer {
    constructor(dom_element, animate, renderer) {
        ...
        // Callback gets invoked with each rendering. User can define the
        // callback by calling the `set_render_callback` command. Defaults to a
        // no-op.
    ...
    set_render_callback(callback) {
        // Sets the per-render use callback. `callback` should be a string that
        // gets evaluated into an anonymous function (the string "null" will
        // clear the callback).
